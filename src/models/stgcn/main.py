# from https://github.com/hazdzz/stgcn/blob/main/main.py
# did some minor changes only concerning imports
...
def prepare_model(args, blocks, n_vertex):
    ...
    if args.opt == "adamw":
        ...
        optimizer = Lion(params=model.parameters(), lr=args.lr, weight_decay=args.weight_decay_rate)
    else:
