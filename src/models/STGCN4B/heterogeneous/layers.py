...
class HeteroSTBlock(nn.Module):
    ...
    def __init__(
        ...
        convs[('device', 'contained_in', 'room')] = GCNConv((-1, -1), ntype_channels_mid['room'], bias=bias)
        convs[('property', 'measured_by', 'device')] = GCNConv((-1, -1), ntype_channels_mid['device'], bias=bias)
        
        # 3. Weather influence relationships
        convs[('outside', 'influences', 'room')] = GCNConv((-1, -1), ntype_channels_mid['room'], bias=bias)
        
        # 4. Time influence relationships
        convs[('time', 'affects', 'room')] = GCNConv((-1, -1), ntype_channels_mid['room'], bias=bias)
        convs[('time', 'affects', 'device')] = GCNConv((-1, -1), ntype_channels_mid['device'], bias=bias)
        convs[('time', 'affects', 'property')] = GCNConv((-1, -1), ntype_channels_mid['property'], bias=bias)
